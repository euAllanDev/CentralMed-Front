      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 h-fit">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input type="text" placeholder="Ex: Unimed João Pessoa" className="w-full mt-1 border p-2 rounded focus:outline-blue-500 bg-white text-gray-900"
          ...
          <div>
            ...
            <input type="text" placeholder="00.000.000/0000-00" className="w-full mt-1 border p-2 rounded focus:outline-blue-500 bg-white text-gray-900"
          ...
          <div>
            ...
            <input type="text" placeholder="Ex: 33964-8" className="w-full mt-1 border p-2 rounded focus:outline-blue-500 bg-white text-gray-900"
      ...
      <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {convenios.map((c) => (
                  <tr key={c.id}>
                      <td className="p-4 font-bold flex items-center gap-2"><Building size={14} className="text-gray-400"/> {c.nome}</td>
